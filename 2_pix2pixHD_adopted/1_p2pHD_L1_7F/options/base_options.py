...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='archi2struct', help='name of the experiment. It decides where to store samples and models')        
...
#        self.parser.add_argument('--dataroot', type=str, default='./datasets/cityscapes/')
        self.parser.add_argument('--dataroot', type=str, default='./datasets/struct_design/')
